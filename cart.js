...
var itenInfo = document.getElementsByClassName("itenInfo");
var ItemName = document.getElementById("ItemName");
var numOfCarItemsHos = document.getElementById("numOfCarItemsHos");
var numOfCarItemsFash = document.getElementById("numOfCarItemsFash");
var numOfCarItemsKids = document.getElementById("numOfCarItemsKids");
...
addingItems[0].addEventListener("click", function(){
    ...
    numOfCarItemsHos.value = numOfItems.innerHTML;
});

addingItems[1].addEventListener("click", function(){

    numOfCarItemsFash.value = numOfItems.innerHTML;
});

addingItems[2].addEventListener("click", function(){

    numOfCarItemsKids.value = numOfItems.innerHTML;
});
